...
REM 用法：在 syntaxflow-ai-training-materials 根目录执行 scripts\build-syntaxflow-aikb-to-libs.cmd
...
if not exist "basic-syntax" (
  echo Error: basic-syntax not found, run from syntaxflow-ai-training-materials root
  exit /b 1
)
...
yak scripts/merge-in-one-text.yak --base . --output "%LIBS_DIR%\syntaxflow-aikb.zip"
if errorlevel 1 exit /b 1

echo [build] Building syntaxflow-aikb.rag...
yak scripts/build-syntaxflow-aikb-rag.yak --base . --output "%LIBS_DIR%\syntaxflow-aikb.rag"
if errorlevel 1 exit /b 1
