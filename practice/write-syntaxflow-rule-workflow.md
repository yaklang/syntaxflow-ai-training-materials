...
- **解决方案**：详见 [rule-self-check-solutions.md](./rule-self-check-solutions.md) 第 2 节
...
- `suggestion`：修复建议
- **解决方案**：详见 [rule-self-check-solutions.md](./rule-self-check-solutions.md) 第 3 节
...
- `rule-self-check-solutions.md`：规则自检未通过时的解决方案（语法错误 + matched=false）
